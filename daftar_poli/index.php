...
<head>
  ...
  <title>Daftar Poli - RS Capstone</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
      ...
      <a href="../" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Capstone Hospital</span>
      </a>
      ...
      <section class="content">
        ...
        <div class="container-fluid">
          <div class="card">
            ...
            <div class="card-body">
              <p class="card-text">Bila belum pernah berobat di RS Capstone, silahkan klik</p>

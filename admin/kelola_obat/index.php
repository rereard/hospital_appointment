            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form>
                  <div class="form-group">
                    <label for="addNamaObat">Nama Obat</label>
                    <input type="text" class="form-control" id="addNamaObat" placeholder="Nama Obat" value="Meth" />
                  </div>
                  <div class="form-group">
                    <label for="addKemasanObat">Kemasan</label>
                    <input type="text" class="form-control" id="addKemasanObat" placeholder="Kemasan" value="plastik" />
                  </div>
                  <div class="form-group">
                    <label for="addHargaObat">Harga</label>
                    <input type="number" class="form-control" id="addHargaObat" placeholder="Harga" value="69000" />
                  </div>
                  <div class="card-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                      Tutup
